...
#    Updated: 2022/08/12 02:11:17 by anguinau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIB				=	libft/libft.a
L_SRCS			=	$(shell find libft/$(SRCSDIR) -type f -name "*.c")
L_INCLUDES		=	$(shell find libft/$(INCLUDESDIR) -type f -name "*.h")
L_OBJS			=	$(subst libft/$(SRCSDIR),libft/$(OBJSDIR),$(L_SRCS:.c=.o))
